...
import replit.ArrayList.Add;

public class AddressList {
    public static void main(String[] args) {
        Address cybertekAddress = new Address();//calling the constructor here automatically
        ...
        cybertekAddress.setState("7925 Jones Branch Dr Suite 3200");
        ...
        System.out.println("papaJohnPizza address:" + papaJohnPizza.toString());
    }
}
